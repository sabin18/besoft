...
import logo from "../../assets/images/BeSoft IT_Logo_FN-01.png"

const Header = () => {
    return (
        <header id="header">
            {/* Navbar */}
            <nav data-aos="zoom-out" data-aos-delay={800} className="navbar navbar-expand border showdow">
                <div className="container header">
                    ...
                    <ul className="navbar-nav items mx-auto">
                        ...
                        {/* <li className="nav-item">
                            <a href="/create" className="nav-link">About Us</a>
                        </li> */}
                         <li className="nav-item">
                            <a href="/solutions" className="nav-link">Solution</a>
                        </li> 
                         <li className="nav-item">
                            <a href="/online-market" className="nav-link">Online market</a>
                        </li>


                        {/* <li className="nav-item dropdown">
                            <a className="nav-link" href="#">About Us <i className="fas fa-angle-down ml-1" /></a>
                            <ul className="dropdown-menu">
                                <li className="nav-item"><a href="/explore-1" className="nav-link">Solution</a></li>
                                <li className="nav-item"><a href="/explore-2" className="nav-link">Online market</a></li>
                    ...
                    <ul className="navbar-nav action">
                        <li className="nav-item ml-3">
                            <a href="/contact" className="btn ml-lg-auto btn-bordered-white bg-primary">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </nav>
